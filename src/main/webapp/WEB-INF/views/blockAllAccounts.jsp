...
<title>All Active Accounts | Admin Panel</title>
...
<h4 class="mb-0">All Deactivation Panel</h4>
...
<a href="blockAccount?accId=<%= acc.getId() %>"
...
<i class="fa fa-lock me-1"></i> Blocked
</span>
